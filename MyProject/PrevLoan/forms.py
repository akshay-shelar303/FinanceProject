...
class PrevLoanForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "branch_name": forms.TextInput(attrs={"placeholder": "Enter Branch Name"}),
            ...
            "loan_amount": forms.TextInput(attrs={"placeholder": "Enter Loan Amount"}),
            "amount_paid": forms.TextInput(attrs={"placeholder": "Enter Amount Paid"}),
            "amount_remaining": forms.TextInput(
                attrs={"placeholder": "Enter Amount Remaining"}
            ),
            "loan_tenure": forms.TextInput(attrs={"placeholder": "Enter Loan Tenure"}),
    ...
    def clean_loan_amount(self):
        ...
        if loan_amount > 1000000:
            raise forms.ValidationError(
                "loan amount should be in between 50000-1000000"
            )
        else:
            return loan_amount
