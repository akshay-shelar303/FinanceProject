...
class PermanentAddressForm(forms.ModelForm):
    class Meta:
        ...
        # placeholder
        widgets = {
            "flat_no": forms.TextInput(attrs={"placeholder": "Enter your flat number"}),
...
class CurrentAddressForm(forms.ModelForm):
    class Meta:
        ...
        # placeholder
        widgets = {
            "flat_no_1": forms.TextInput(
                attrs={"placeholder": "Enter your flat number"}
            ),
            "street_name_1": forms.TextInput(
                attrs={"placeholder": "Enter street name"}
            ),
