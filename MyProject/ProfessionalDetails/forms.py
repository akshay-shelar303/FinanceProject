...
class SalariedModelForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "year_of_exp": forms.TextInput(
                attrs={"placeholder": "Experience in Years"}
            ),
            "monthly_income": forms.TextInput(
                attrs={"placeholder": "Enter Income in Thousands"}
            ),
...
class SelfSalariedModelForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "avg_monthly_income": forms.TextInput(
                attrs={"placeholder": "Enter Income in Thousands"}
            ),
            "annual_turnover": forms.TextInput(
                attrs={"placeholder": "Enter Turnover in Lakhs"}
            ),
            "customer": forms.TextInput(attrs={"readonly": "readonly"}),
        }
