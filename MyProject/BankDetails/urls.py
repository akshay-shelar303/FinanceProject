...
from .views import (
    create_bankdetails_view,
    show_bankdetails_view,
    update_bankdetails_view,
    delete_bankdetails_view,
)

urlpatterns = [
    path("cBankDetails/<int:i>/", create_bankdetails_view, name="cBankDetailspg"),
