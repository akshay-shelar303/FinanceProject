...
class LoanDetailsForm(forms.ModelForm):
    class Meta:
        ...
        labels = {"dob": "Date Of Birth", "required_loan": "Required Loan Amount"}
        ...
        widgets = {
            ...
            "pan_number": forms.TextInput(
                attrs={"placeholder": "Enter your Pan Number"}
            ),
            "required_loan": forms.TextInput(
                attrs={"placeholder": "Enter Required loan amount"}
            ),
    ...
    def clean_required_loan(self):
        ...
        if required_amount < 50000 or required_amount > 1500000:
            raise forms.ValidationError(
                "In valid amount(must be between 50K to 15 Lac)"
            )
    ...
    class Meta:
        ...
        widgets = {
            ...
            "email": forms.TextInput(
                attrs={"placeholder": "Enter email ex: abc@gmail.com"}
            ),
